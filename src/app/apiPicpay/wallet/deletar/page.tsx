...
export default function Home() {
  ...
  const handleSendRequest = async () => {
    ...
    if (!walletID) {
      alert("Por favor, insira o ID da carteira.");
      return;
    }

    try {
      const response = await axios.delete(
        `https://api-picpay.2fs.com.br/wallets/${walletID}`,
        {
          headers: {
            ...
            <div className="lg:grid-cols-2 lg:justify-left gap-12">
              ...
              >
                <div className="flex flex-row w-full m-1 justify-between items-center text-bold border-b-2 border-black pb-2">
                  ...
                  Endpoint
                    <strong>&nbsp;/wallets/id</strong>
                  </h1>
                  <div className="flex justify-end">
                    <div className="flex items-center mr-4">
                      <label htmlFor="walletID" className="mr-2 font-semibold">
                        ID da carteira:
                      </label>
                      <input
                        id="walletID"
